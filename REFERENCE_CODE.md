...
| Persisted settings and diagnostic record decoding | `tau-alpha/tools/decode_tau_diag_log.py`, `tau-alpha/fw/settings.inc`, `tau-alpha/fw/player.c` (`lib_h`, `lib_hb`, `lib_hs`) | `--interact` decodes `interact_persist.json`. |
